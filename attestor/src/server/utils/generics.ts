 ...
 * Supports two modes:
 * 1. PRIVATE_KEY - Direct private key (current mode)
 * 2. MNEMONIC - Mnemonic phrase for TEE-derived wallet (EigenCompute mode)
 */
...
const PRIVATE_KEY = getOperatorPrivateKey()
